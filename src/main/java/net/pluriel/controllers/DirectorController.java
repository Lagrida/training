...
public class DirectorController {
	...
	public ResponseEntity<DirectorResponseDto> updateDirector(@PathVariable Integer id,@RequestBody DirectorRequestDto directorRequestDto) {
		return new ResponseEntity<DirectorResponseDto>(directorService.updateDirector(id, directorRequestDto), HttpStatus.CREATED);
	}
}
