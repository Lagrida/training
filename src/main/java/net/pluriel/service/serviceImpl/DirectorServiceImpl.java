...
public class DirectorServiceImpl implements DirectorService{
	...
	public DirectorResponseDto updateDirector(Integer id, DirectorRequestDto directorRequestDto) {
	    Director director = directorRepostiory.findById(id).orElseThrow(() -> new IllegalArgumentException("Doctor not found"));
	   // Director director2=    directorMapper.convertRequestDtoToEntity(directorRequestDto);
